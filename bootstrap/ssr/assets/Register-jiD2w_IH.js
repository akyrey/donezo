...
function Register({ invitationToken, invitationEmail }) {
	...
	const submit = (e) => {
		e.preventDefault();
		post(register.url(), { onFinish: () => reset("password", "password_confirmation") });
	};
	return /* @__PURE__ */ jsxs(GuestLayout, { children: [/* @__PURE__ */ jsx(Head, { title: "Create account" }), /* @__PURE__ */ jsxs("div", {
		...
		children: [
			/* @__PURE__ */ jsxs("div", {
				...
				children: [/* @__PURE__ */ jsx("h1", {
					...
					children: invitationToken ? "Create your account to accept the group invitation" : "Start organizing your tasks with Donezo"
				})]
			}),
			/* @__PURE__ */ jsxs("div", {
				className: "space-y-3",
				children: [/* @__PURE__ */ jsx(Button, {
					...
					children: /* @__PURE__ */ jsxs("a", {
						href: invitationToken ? `/auth/google/redirect?invitation=${invitationToken}` : "/auth/google/redirect",
					...
					asChild: true,
					children: /* @__PURE__ */ jsxs("a", {
						href: invitationToken ? `/auth/github/redirect?invitation=${invitationToken}` : "/auth/github/redirect",
