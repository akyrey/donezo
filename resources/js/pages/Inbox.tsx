      ...
      <div className="mx-auto max-w-2xl px-4 py-8">
        <div className="mb-8 flex items-center justify-between">
          <h1 className="text-text flex items-center gap-3 text-2xl font-semibold">
            <InboxIcon className="text-primary h-6 w-6" />
            Inbox
          </h1>
          <Button
            variant="ghost"
        ...
        {tasks.length > 0 ? (
          ...
          <div className="flex flex-col items-center justify-center py-20 text-center">
            <div className="bg-bg-secondary mb-4 flex h-16 w-16 items-center justify-center rounded-full">
              <InboxIcon className="text-text-tertiary h-8 w-8" />
            </div>
            <h2 className="text-text text-lg font-medium">Your inbox is empty</h2>
            <p className="text-text-secondary mt-1 text-sm">Capture new tasks here.</p>
          </div>
        )}
      </div>
